...
The code and commands I used to benchmark each of these are available in [the Chapel test directory](https://github.com/chapel-lang/chapel/tree/main/test/library/packages/Sort/performance/comparison).
